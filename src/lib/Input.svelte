<svelte:options tag="twopine-input" />
...
{#if type === "text"}
    <div class="form-field">
        ...
        {/if}
        <input {placeholder} {type} {name} {required} {disabled}/>
    </div>
{/if}
...
{#if type === "password"}
    <div class="form-field">
        {#if label}
            <label for={name}>{label}</label>
        {/if} <input {placeholder} type={show ? "text" : "password"} {name} {required} {disabled} />
        {#if show === false}
            <svg
...
{#if type === "radio"}
    <div class="form-field">
        {#if label}
            <label for={name}>{label}</label>
        {/if} <input {placeholder} {type} {name} {required} {disabled} />
    </div>
{/if}
...
<style>
    ...
    input:focus-within {
        outline: var(--border-width) var(--border-style)
